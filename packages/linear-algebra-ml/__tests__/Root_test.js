...
describe("Bisection method", (function () {
        Jest.test("Root of 10", (function (param) {
                return Jest.Expect[/* toEqual */12](3.162277660168379, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.bisection(undefined, (function (param) {
                                      return Root$AppliedLinearAlgebra.intermediate_zero(10.00, param);
                                    }), -2.00, 5.00)));
              }));
        Jest.test("Root of 9", (function (param) {
                return Jest.Expect[/* toEqual */12](3.00, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.bisection(undefined, (function (param) {
                                      return Root$AppliedLinearAlgebra.intermediate_zero(9.00, param);
                                    }), -2.00, 6.00)));
              }));
        Jest.test("Root of 16", (function (param) {
                return Jest.Expect[/* toEqual */12](4.00, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.bisection(undefined, (function (param) {
                                      return Root$AppliedLinearAlgebra.intermediate_zero(16.00, param);
                                    }), -2.00, 6.00)));
              }));
        Jest.test("Root of 11", (function (param) {
                return Jest.Expect[/* toEqual */12](3.3166247903554, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.bisection(undefined, (function (param) {
                                      return Root$AppliedLinearAlgebra.intermediate_zero(11.00, param);
                                    }), -2.00, 5.00)));
              }));
...
describe("Square root function", (function () {
        Jest.test("Root of (11)", (function (param) {
                return Jest.Expect[/* toEqual */12](3.3166247903554, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.float_sqroot(11.00)));
              }));
        Jest.test("Root of (-4.587)", (function (param) {
                return Jest.Expect[/* toEqual */12](4.587, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.float_sqroot(-4.587 * -4.587)));
              }));
        Jest.test("Root of (0.685)", (function (param) {
                return Jest.Expect[/* toEqual */12](0.6849999999999996, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.float_sqroot(0.685 * 0.685)));
              }));
        return Jest.test("Root of (8.444\xc2\xb2)", (function (param) {
                      return Jest.Expect[/* toEqual */12](8.444, Jest.Expect[/* expect */0](Root$AppliedLinearAlgebra.float_sqroot(8.444 * 8.444)));
                    }));
      }));
